    ...
    def _load_camera_character_animation(self):
        ...
        if isinstance(char_name, int):
            try:
                ...
                char_stage  = characters[char_name].get("type", "baby")
        ...
        # happy, tail, tear 3세트 프리로드
        from PIL import Image
        for anim_name in ("happy", "tail", "tear"):
            anim_dir = f"frontend/assets/characters/{char_name}/{char_stage}/{anim_name}"
            frames = []
